/* Praedra sim module: match — orchestration, state setup, public Praedra API — DOM-free, deterministic. Part of the sim manifest
...
var Praedra = api; // browser: global export; harness closure returns it
